...
### Important
- Existing preview users must have v1beta1 as the only served and stored version before
  upgrading to this release. CRD `storedVersions` must be `["v1beta1"]` and v1alpha1 must
  not be served.
