...
[CockroachDB](https://github.com/cockroachdb/cockroach) - the source available, cloud-native distributed SQL database.
...
my-release-cockroachdb-0    cockroachdb/cockroach:v25.4.3
my-release-cockroachdb-1    cockroachdb/cockroach:v25.4.3
my-release-cockroachdb-2    cockroachdb/cockroach:v25.4.3
my-release-cockroachdb-3    cockroachdb/cockroach:v25.4.3
```
...
| `image.tag`                                               | Container image tag                                                                                                                                                                                                                                                                                                                      | `v25.4.3`                                   |
