...
```
my-release-cockroachdb-0    cockroachdb/cockroach:v20.2.0
my-release-cockroachdb-1    cockroachdb/cockroach:v20.2.0
my-release-cockroachdb-2    cockroachdb/cockroach:v20.2.0
my-release-cockroachdb-3    cockroachdb/cockroach:v20.2.0
```
...
| `image.tag`                                               | Container image tag                                             | `v20.2.0`                                        |
