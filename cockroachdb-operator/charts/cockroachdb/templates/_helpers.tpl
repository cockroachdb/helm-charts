...
👉 Learn more about the CockroachDB Operator: cockroachdb-operator/charts/cockroachdb/README.md
🔄 Follow the migration steps at docs/migration/helm/controller_migration.md`) -}}
{{- end -}}
{{- end }}
