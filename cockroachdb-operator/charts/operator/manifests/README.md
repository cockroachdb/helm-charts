...
kubectl apply --server-side \
  -f cockroachdb-operator/charts/operator/manifests/crds

kubectl apply \
  -f cockroachdb-operator/charts/operator/manifests/cockroachdb-operator.yaml
...
```shell
kubectl apply \
  -f cockroachdb-operator/charts/operator/manifests/examples/crdb/rbac.yaml

kubectl apply \
  -f cockroachdb-operator/charts/operator/manifests/examples/crdb/insecure.yaml
```
