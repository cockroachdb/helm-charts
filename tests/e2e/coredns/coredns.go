...
`)
	...
	for _, clusterDomain := range clusters {
		...
		//
		// TODO(joel): force_tcp was originally included because AWS NLBs did
...
func ToYamlService(t *testing.T, obj runtime.Object) string {
...
func ToYamlDeployment(t *testing.T, obj runtime.Object) string {
	// Create a new scheme and add the types we need
	scheme := runtime.NewScheme()
...
func ToYamlConfigmap(t *testing.T, obj runtime.Object) string {
	// Create a new scheme and add the types we need
	scheme := runtime.NewScheme()
