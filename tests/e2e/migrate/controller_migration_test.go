...
func testHelmAutoForwardMigration(t *testing.T) {
	...
	defer func() {
		...
		_ = helm.DeleteE(t, &helm.Options{KubectlOptions: kubectlOptions}, autoMigrationOperatorRelease, true)
	...
	defer uninstallMigrationOperator(t, kubectlOptions)
...
func testOperatorAutoForwardMigration(t *testing.T) {
	...
	// Cleanup public operator resources.
